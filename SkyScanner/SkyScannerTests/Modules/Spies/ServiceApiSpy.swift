...
class ServiceApiSuccesSpy: ServiceApiProtocol {
    ...
    func pollSession(sessionUrl: String, apiKey: String, pageIndex: Int, pageSize: Int, sortType: String, sortOrder: String, onSuccess: @escaping ((Data) -> Void), onFailure: @escaping ((NSError?, Int) -> Void)) {
